...
`define DEFINE_V
    ...
    // make sure to translate spi address space to ricosoc's

    `define RICOSOC_PERIPH_START_ADDR       32'h0200_0000
    `define RICOSOC_PERIPH_END_ADDR         32'h02FF_FFFF
    `define RICOSOC_PERIPH_PAGE_SIZE        32'h0000_0100
    ...
    `define RICOSOC_SPIEX_PERIPH_NUM        1
    `define RICOSOC_SPIEX_BASE_ADDR         `RICOSOC_PERIPH_START_ADDR + (`RICOSOC_PERIPH_PAGE_SIZE * `RICOSOC_SPIEX_PERIPH_NUM)
    `define RICOSOC_SPIEX_CFGREG_ADDR       8'h00 + `RICOSOC_SPIEX_BASE_ADDR

    `define RICOSOC_GPIO0_PERIPH_NUM        2
    `define RICOSOC_GPIO0_BASE_ADDR         `RICOSOC_PERIPH_START_ADDR + (`RICOSOC_PERIPH_PAGE_SIZE * `RICOSOC_GPIO0_PERIPH_NUM)
    `define RICOSOC_GPIO1_PERIPH_NUM        3
    `define RICOSOC_GPIO1_BASE_ADDR         `RICOSOC_PERIPH_START_ADDR + (`RICOSOC_PERIPH_PAGE_SIZE * `RICOSOC_GPIO1_PERIPH_NUM)
    ...
    `define RICOSOC_GPIOx_ODR_ADDR          8'h00
    `define RICOSOC_GPIOx_IDR_ADDR          8'h04
    `define RICOSOC_GPIOx_DDR_ADDR          8'h08
    `define RICOSOC_GPIOx_MODE_ADDR         8'h0C

    `define GPIO0_ODR_ADDR                  (`RICOSOC_GPIO0_BASE_ADDR + `RICOSOC_GPIOx_ODR_ADDR)
    `define GPIO0_IDR_ADDR                  (`RICOSOC_GPIO0_BASE_ADDR + `RICOSOC_GPIOx_IDR_ADDR)
    ...
    `define GPIO1_ODR_ADDR                  (`RICOSOC_GPIO1_BASE_ADDR + `RICOSOC_GPIOx_ODR_ADDR)
    `define GPIO1_IDR_ADDR                  (`RICOSOC_GPIO1_BASE_ADDR + `RICOSOC_GPIOx_IDR_ADDR)
