...
`define RICOSOC_ROM_END_ADDR            32'h01FF_FFFF

`define RICOSOC_EXTFLASH_START_ADDR     32'h0200_0000
`define RICOSOC_EXTFLASH_END_ADDR       32'h02FF_FFFF

`define RICOSOC_PERIPH_START_ADDR       32'h0300_0000

`define RICOSOC_UART0_BASE_ADDR         32'h0300_0000
`define RICOSOC_UARTx_CLKDIV_ADDR       8'h00
`define RICOSOC_UARTx_DATA_ADDR         8'h04

`define RICOSOC_GPIO0_BASE_ADDR         32'h0300_0100
`define RICOSOC_GPIO1_BASE_ADDR         32'h0300_0200
`define RICOSOC_GPIOx_PORT_ADDR         8'h00
`define RICOSOC_GPIOx_DDR_ADDR          8'h04
`define RICOSOC_GPIOx_MODE_ADDR         8'h08

`define RICOSOC_PERIPH_END_ADDR         32'h03FF_FFFF
